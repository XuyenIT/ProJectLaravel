...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="font_end/Hoang/css/coming.css" type="text/css">
    <!--Fontanwsome CDN-->
  ...
  <body>
                    ...
                    <div class="page-titleFilms ">
                        <div class="row titleFilms">
                            ...
                            <div class="sub-caterory">
                                <a href="{{URL::to('Now-Showing')}}">NOW SHOWING</a>
                            </div>
                        </div>
                    </div>
                    <div class="list-film">
                        <div class="row product-films">
                            <div class="col-md-3 col-sm-6 col-xs-6 film_items">
                                <div class="film-imgs">
                                    <a href="#" class="film-img">
                                        <img src="font_end/Hoang/images/hr1.jpg" alt="">
                                    </a>
                                </div>
                            ...
                            <div class="col-md-3 col-sm-6 col-xs-6 film_items">
                                <div class="film-imgs">
                                    <a href="#" class="film-img">
                                        <img src="font_end/Hoang/images/hr2.jpg" alt="">
                                    </a>
                                </div>
                                <div class="film-content">
                                    <h2 class="film-name">
                            ...
                            <div class="col-md-3 col-sm-6 col-xs-6 film_items">
                                <div class="film-imgs">
                                    <a href="#" class="film-img">
                                        <img src="font_end/Hoang/images/hr3.jpg" alt="">
                                    </a>
                                </div>
                                <div class="film-content">
                                    <h2 class="film-name">
                            ...
                            <div class="col-md-3 col-sm-6 col-xs-6 film_items">
                                <div class="film-imgs">
                                    <a href="#" class="film-img">
                                        <img src="font_end/Hoang/images/hr4.jpg" alt="">
                                    </a>
                                </div>
                                <div class="film-content">
                                    <h2 class="film-name">
                            ...
                            <div class="col-md-3 col-sm-6 col-xs-6 film_items">
                                <div class="film-imgs">
                                    <a href="#" class="film-img">
                                        <img src="font_end/Hoang/images/hr5.jpg" alt="">
                                    </a>
                                </div>
                                <div class="film-content">
                                    <h2 class="film-name">
                            ...
                            <div class="col-md-3 col-sm-6 col-xs-6 film_items">
                                <div class="film-imgs">
                                    <a href="#" class="film-img">
                                        <img src="font_end/Hoang/images/hr6.jpg" alt="">
                                    </a>
                                </div>
                                <div class="film-content">
                                    <h2 class="film-name">
                            ...
                            <div class="col-md-3 col-sm-6 col-xs-6 film_items">
                                <div class="film-imgs">
                                    <a href="#" class="film-img">
                                        <img src="font_end/Hoang/images/hr7.jpg" alt="">
                                    </a>
                                </div>
                                <div class="film-content">
                                    <h2 class="film-name">
                            ...
                            <div class="col-md-3 col-sm-6 col-xs-6 film_items">
                                <div class="film-imgs">
                                    <a href="#" class="film-img">
                                        <img src="font_end/Hoang/images/hr8.jpg" alt="">
                                    </a>
                                </div>
                                <div class="film-content">
                                    <h2 class="film-name">
    ...
    <script src="js/coming.js" type="text/javascript"></script>
  </body>
</html>